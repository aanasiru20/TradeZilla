        ...
        <div className="bg-slate-900 rounded-lg shadow-lg p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="mt-6 w-full flex items-center justify-center gap-3 py-2 px-4 bg-white hover:bg-gray-50 text-gray-900 font-medium rounded transition disabled:opacity-70"
            >
